...
begin
    ...
    where (p_employee_id is null or employee_id = p_employee_id)
      ...
      and (p_employee_nic is null or employee_nic = p_employee_nic)
      and (p_birthday is null or birthday = p_birthday)
      and (p_gender is null or gender = p_gender)
      and (p_marital_status is null or marital_status = p_marital_status)
      and (p_number_of_dependents is null or number_of_dependents = p_number_of_dependents)
      and (p_address is null or address = p_address)
      and (p_contact_number is null or contact_number = p_contact_number)
      and (p_business_email is null or business_email = p_business_email)
