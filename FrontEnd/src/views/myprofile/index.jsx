    ...
    const getmyprofiledata = async (user_name) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('My profile data received:', data);
                
            } else {
                console.error('Failed to receive profile data:', response.status);
            }
        } catch (error) {
            console.error('Error occurred while fetching my profile data:', error);
        } finally {
            setIsSubmitting(false);
            console.log("this is data i use",employeeDetails);
        }
    };
